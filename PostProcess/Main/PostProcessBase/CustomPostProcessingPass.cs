...
namespace TK.Rendering.PostFX
{
    public abstract class CustomPostProcessingPass<T> : ScriptableRenderPass where T : VolumeComponent
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            CustomAfterRenderExcute(context, ref renderingData);
            context.ExecuteCommandBuffer(commandBuffer);
            CommandBufferPool.Release(commandBuffer);
            CustomAfterExcuteCommandBuffer(context, ref renderingData);
        }
        protected virtual void CustomAfterRenderExcute(ScriptableRenderContext context, ref RenderingData renderingData) { }
        protected virtual void CustomAfterExcuteCommandBuffer(ScriptableRenderContext context, ref RenderingData renderingData) { }
